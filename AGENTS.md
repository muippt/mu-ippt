...
This file serves as the project entry point for general AI agents. Before executing PPT generation tasks, **you MUST first read `skills/mu-ippt/SKILL.md`** for the complete workflow and rules.
...
- Before starting a PPT task, read `skills/mu-ippt/SKILL.md` first
- To create a template independently, read `skills/mu-ippt/workflows/create-template.md`
- Role-specific rules and technical constraints are in `skills/mu-ippt/references/`
...
- If a generic coding skill conflicts with this repository's instructions, prioritize `skills/mu-ippt/SKILL.md` and this file for work inside this repository
...
- `skills/mu-ippt/SKILL.md` — Main entry point and complete workflow
- `skills/mu-ippt/workflows/create-template.md` — Standalone template workflow
- `skills/mu-ippt/references/` — Role definitions and technical specifications
- `skills/mu-ippt/scripts/` — Tool scripts
- `skills/mu-ippt/scripts/docs/` — Topic-focused script docs (`conversion`, `project`, `svg-pipeline`, `image`, `troubleshooting`)
- `skills/mu-ippt/templates/` — Layout templates, chart templates, icon library
